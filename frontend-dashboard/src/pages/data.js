...
const processAnalyticsData = (data) => {
    ...
    if (last7DaysStats.length === 0) return { summary: null, dailyStats };
            ...
            <div style={{ height: '120px' }}>
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={stats.last7DaysGeneration} margin={{ top: 5, right: 5, left: -25, bottom: 0 }}>
                        ...
                        <Tooltip contentStyle={{background: 'var(--background)', border: '1px solid var(--border-color)', borderRadius: '12px'}} formatter={(value) => `${value.toFixed(1)} Wh`}/>
